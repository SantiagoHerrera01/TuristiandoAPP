...
public class Turismo {
    public static void main(String[] args) throws Exception {
        ...
        //usuario.setDocmento(Read.nextLine());
        //System.out.print("Digite su correo: ");
        //usuario.setCorreo(Read.nextLine());
        //System.out.print("Digite su direccion Siendo: 1. zona centro, 2. Sur, 3. Norte, 4. Otras): ");
        //usuario.setUbicacion(Read.nextLong());

        //System.out.println("\u001B[34m1. Datos de la empresa\u001B[0m");
        //System.out.println("Ingrese el nit de la empresa: ");
        //local.setNit(Read.nextLine());
